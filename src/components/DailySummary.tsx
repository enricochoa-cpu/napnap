    ...
    <div className="card p-5">
      ...
      <div className="grid grid-cols-4 gap-3">
        ...
        <div className="text-center">
          <div className="w-9 h-9 mx-auto mb-2 rounded-full bg-[var(--nap-color)]/15 flex items-center justify-center">
            <svg className="w-4 h-4 text-[var(--nap-color)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z" />
            </svg>
          </div>
          <div className="stat-value stat-value-nap text-base">
