...
export function QuickActionSheet({
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <>
          {/* Backdrop — opacity follows drag so swipe-down feels connected */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          {/* Bottom Sheet — tween (no bounce); drag down to dismiss */}
          <motion.div
            ref={dialogRef}
            role="dialog"
            aria-modal="true"
          ...
          >
            ...
            >
              {/* Handle bar — drag here to dismiss */}
              <div className="flex justify-center pt-3 pb-2 mb-6 cursor-grab active:cursor-grabbing">
