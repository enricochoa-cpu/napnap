# 2026-02-25 — Stats screen: edge-to-edge charts, premium look, one-point growth, Y-axis visibility
...
- **lessons.md:** New §7.5 — Recharts YAxis `width={0}` hides tick labels; use width > 0 and keep edge-to-edge via wrapper `-mx-4`.
